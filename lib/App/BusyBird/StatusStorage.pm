...
This document is mainly for implementors of App::BusyBird::StatusStorage::* modules.
...
The above methods are the basis of L<App::BusyBird::Timeline>'s methods of the same names.
See L<App::BusyBird::Timeline> for the specification.

In addition to L<App::BusyBird::Timeline>'s specification,
