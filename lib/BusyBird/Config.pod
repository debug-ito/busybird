...
This document should not refer to the Tutorial (it is a cyclic ref!). This document should refer to Main and Timeline.

TODO: need examples. (1) Timestamp customization. (2) entity builder. (3) original share-dir. (4) status storage.
...
TODO: note that all params in this category can also be set in Main (global config).
