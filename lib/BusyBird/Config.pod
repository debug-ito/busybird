...
=head2 C<default_status_permalink_builder> => CODEREF($status)
...
=head2 C<urls_entity_url_builder> => CODEREF($entity, $status)

B<Default:> return C<< $entity->{display_url} >>

=head2 C<media_entity_url_builder> => CODEREF($entity, $status)

B<Default:> return C<< $entity->{display_url} >>

=head2 C<user_mentions_entity_url_builder> => CODEREF($entity, $status)

B<Default:> build URL to the user page of twitter.com

=head2 C<hashtags_entity_url_builder> => CODEREF($entity, $status)
