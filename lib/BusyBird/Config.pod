...
This document describes how to configure L<BusyBird>.

=head2 Config File

By default, L<BusyBird> reads the file C<~/.busybird/config.psgi> as the configuration file.
...
- need not to be so verbose. this is covered by Tutorial already.
...
=head2 Entity Builders

=head2 Customize Share-dir
