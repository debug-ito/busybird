...
=head1 SYNOPSIS
    ...
    my $input = BusyBird::Input::Twitter->new(
...
to load a timeline for L<BusyBird>.
...
=head2 $input = BusyBird::Input::Twitter->new(%options);
...
The first is the L<BusyBird::Input::Twitter> object.
