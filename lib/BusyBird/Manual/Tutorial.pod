...
After that, you can see the imported feed items (in this case, CPAN modules recently uploaded) on L<BusyBird>.
...
Now you see the Twitter statuses on "home" timeline, don't you?
