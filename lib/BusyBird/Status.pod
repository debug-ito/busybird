...
This is the specification of a status object that is handled by L<BusyBird> (especially L<BusyBird::StatusStorage> and
L<BusyBird::Timeline>).
...
To further customize status permalinks, see C<status_permalink_builder> of L<BusyBird::Config>.
...
see C<time_zone>, C<time_format>, C<time_locale> of L<BusyBird::Config>.
...
see C<*_entitiy_url_builder> and C<*_entity_text_builder> of L<BusyBird::Config>.
