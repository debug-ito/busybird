...
sub testClone {
    diag("testClone");
    my $orig = new_ok('BusyBird::Status');
    ...
    cmp_ok(DateTime->compare($orig->getDateTime, $clone->getDateTime), '==', 0, 'time is the same');
